...
<sub>Expires in ${INPUT_EXPIRES_DAYS:-7} days · Updated $(date -u '+%b %d, %Y %H:%M UTC') · Generated by [CodeLayers Action](https://github.com/codelayers-ai/codelayers-action)</sub>
EOF
)
